...
const defaultPrompts = [
  "Use VBA code to create a macro that automatically formats a range of cells, such as applying bold text or a border to all cells in a column.",
  "Use VBA code to create a macro that automatically adds or removes rows or columns in a worksheet, based on the values in a specified range of cells.",
];
...
const Vba = () => {
  ...
  const handleSubmitRequest = async (type) => {
    ...
    let { data } = await axios.post(`${BASE_URL}/ans/vba`, {
    ...
    >
      <div className="xs:w-1/2 xs:mr-2 bg-gray-50 xs:border p-2 xs:p-4 xs:rounded-lg">
        ...
        <div className="hidden xs:block mb-6">
          <p className="text-xs mb-1">
            What is the VBA code you want to generate?
          </p>
