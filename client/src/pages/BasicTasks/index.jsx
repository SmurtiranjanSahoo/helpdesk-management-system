...
const defaultPrompts = [
  "Create a chart that dynamically updates based on the values in a range of cells, such as a line chart that shows a trend over time.",
  "Create a pivot table based on column and group by column B and sum column D.",
  "Create a pivot table with multiple levels of grouping, such as by date, product, and region, to analyze data at different levels of detail.",
  "Use conditional formatting to highlight cells that meet certain criteria, such as values that are above or below a specified threshold.",
];
...
const BasicTasks = () => {
  ...
  const handleSubmitRequest = async (type) => {
    ...
    let { data } = await axios.post(`${BASE_URL}/ans/basic-tasks`, {
    ...
    >
      <div className="xs:w-1/2 xs:mr-2 bg-gray-50 xs:border p-2 xs:p-4 xs:rounded-lg">
        ...
        <div className="hidden xs:block mb-6">
          <p className="text-xs mb-1">
            Describe what you want to achieve in excel?
          </p>
